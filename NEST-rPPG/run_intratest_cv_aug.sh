...
#
# PURE: participant 07 (tachycardia, ~130 BPM) is included in folds but excluded
# from augmentation — their HR is already high and further compression would
# produce out-of-range labels.
